...
<style>
  ...
  .modal-close{
   ...
   .modal-close:hover{
    ...
    box-shadow:inset white 0px 0px 30px -12px rgba(0, 0, 0, 0.25) 0px 54px 55px, rgba(0, 0, 0, 0.12) 0px -12px 30px, rgba(0, 0, 0, 0.12) 0px 4px 6px, rgba(0, 0, 0, 0.17) 0px 12px 13px, rgba(0, 0, 0, 0.09) 0px -3px 5px;
   }
  img {
    max-width: 100%;
  }
