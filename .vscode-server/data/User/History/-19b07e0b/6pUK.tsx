...
// Charger les données
const data = JSON.parse(readFileSync(join(__dirname, '../backend/data.json'), 'utf-8'));
...
// Fonction pour analyser les transactions mensuelles
...
// Fonction pour calculer les pourcentages des catégories
...
// Fonction principale pour obtenir l'analyse annuelle
