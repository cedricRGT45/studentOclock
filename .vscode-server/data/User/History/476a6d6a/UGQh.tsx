...
export function Account({ header }: AccountProps) {
    ...
    return (
        <>
                    ...
                    {displayedData === "subjects" && subjectsData?.map((classItem: Class) => (
                        <div key={classItem.id}>
                            <Card
                                ...
                                setOpenModal={setOpenModal}
                                setEditedData={setEditedData}
                                setClassData={setSubjectsData} // Renamed to setSubjectsData
                            />
                        </div>
                    ))}
            ...
            <Toaster />
            {openModal && <ModalEdit open={openModal} setOpen={setOpenModal} editedData={editedData} displayedData={displayedData} setWizardData={setWizardsData} setClassData={setSubjectsData} setRoomData={setRoomsData} />}
        </>
    );
}
