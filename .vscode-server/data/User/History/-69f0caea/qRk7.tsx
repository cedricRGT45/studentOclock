  ...
  return (
    <div className="home">
        <div className="buttons">
            <button onClick={handleShowProfessors}  className={`btn ${view === "professors" ? "btn-active" : ""}`}>Professeurs</button>
            <button onClick={handleShowSubjects}  className={`btn ${view === "professors" ? "btn-active" : ""}`}>Matières</button>
        </div>
        {view === "professors" && (
